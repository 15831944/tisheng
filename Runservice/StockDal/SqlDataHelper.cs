...
namespace StockDal
{
    public class SqlDataHelper
    {
        ...
        //public static bool ExecSqlWithTips(string sqlstr, string tips)
        //{
        ...
        /// <param name="sqlqueryfield"></param>
        /// <param name="sqlwhere"></param>
        /// <param name="Page"></param>
        /// <param name="PageSize"></param>
        /// <returns></returns>
        public static string GetPageSql(string tablename, string tableid, string sqlqueryfield, string sqlwhere, int Page, int PageSize)
        {
            if (PageSize != -1)
            {
                string sqlstr = $"select  {sqlqueryfield} from {tablename} where 1=1  {sqlwhere} order by {tableid}";
                return sqlstr;
            }
            else
            {
                StringBuilder sb = new StringBuilder("select top");
                sb.AppendFormat("{0} {1} from {2} where 1=1 ", PageSize, sqlqueryfield, tablename);
                sb.Append(sqlwhere);
                if (Page>1)
                {
                    sb.AppendFormat(" and {0} > (select Max({1}) from (select top {2} {3} from {4} where 1=1 ", tableid, tableid, (Page - 1) * PageSize, tableid, tablename);
                    sb.Append(sqlwhere);
                    sb.AppendFormat(" order by {0} ) a ) ", tableid);

                }
                sb.AppendFormat(" order by {0} ", tableid);
                return sb.ToString();
            }
        }
        ...
        public static DataSet ExcuteDataSet(SqlConnection connection, SqlTransaction transaction, string sql, params SqlParameter[] sqlParameters)
        {
            if (connection == null)
            {
            ...
            PrepareCommand(cmd, connection, transaction, CommandType.Text, sql, sqlParameters, out mustCloseConnection);
        ...
        public static void SetConnStr(string db_ip, string db_port, string db_name, string userid, string pwd)
        {
            string sqlurl = "";
            ...
            {
                sqlurl = db_ip + "," + db_port;
            }
            my_connstr = string.Format(tem_connstr, new object[] {
                sqlurl,
                db_name,
                userid,
                pwd
        ...
        public static void SetConnMgStr(string db_ip, string db_port, string db_name, string userid, string pwd)
        {
            string sqlurl = "";
            if (db_port == "" || db_port == null)
            {
            ...
            mg_connstr = string.Format(tem_connstr, new object[] {
                sqlurl,
                db_name,
                userid,
                pwd
        ...
        public static string GetMGConnString()
        {
            return mg_connstr;
        }
        /// <summary>   
        ...
        {
            SqlConnection Connection = new SqlConnection(SqlDataHelper.GetConnString());
            return Connection;
        }
        ...
        public static bool ConnectionTest()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(SqlDataHelper.GetConnString()))
                {
                    conn.Open();
                    conn.Close();
                    return true;
        ...
        public static bool ConnectionMgTest()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(SqlDataHelper.GetMGConnString()))
                {
                    conn.Open();
                    conn.Close();
                    return true;
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlDataHelperParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数   
                SqlParameter[] commandParameters = SqlDataHelperParameterCache.GetSpParameterSet(connection, spName);
        ...
        public static string ExecuteProcedureByParameters(SqlConnection connection, string spName,
            params object[] parameterValues)
        {
            return ExecuteProcedureByParameters(null, connection, spName, parameterValues);
        }

        public static string ExecuteProcedureByParameters(SqlTransaction transaction, SqlConnection connection, string spName, params object[] parameterValues)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            // 清除参数,以便再次使用.  
            string value = (string)cmd.Parameters[cmd.Parameters.Count - 1].Value;
            cmd.Parameters.Clear();
            if (mustCloseConnection)
                connection.Close();
            return value;
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlDataHelperParameterCache.GetSpParameterSet(transaction.Connection, spName);
        ...
        {
            return ExecuteDataSet(null, connection, commandType, commandText, commandParameters);
        }
        public static DataSet ExecuteDataSet(SqlTransaction transaction, SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        public static DataTable ExecuteDataTable(SqlConnection conn, String sql, params SqlParameter[] pms)
        {
        ...
        public static DataTable ExecuteDataTable(SqlConnection conn, SqlTransaction tran, string sqlstr, params SqlParameter[] pms)
        {
        ...
        /// <summary>   
        /// 枚举,标识数据库连接是由SqlDataHelper提供还是由调用者提供   
        /// </summary>   
        private enum SqlConnectionOwnership
        {
            /// <summary>由SqlDataHelper提供连接</summary>   
            Internal,
        ...
        /// </summary>   
        /// <remarks>   
        /// 如果是SqlDataHelper打开连接,当连接关闭DataReader也将关闭.   
        ...
        /// <param name="connectionOwnership">标识数据库连接对象是由调用者提供还是由SqlDataHelper提供</param>   
        ...
        /// <param name="commandParameters">分配给命令的SqlParamter参数数组</param>   
        /// <returns>返回结果集中的第一行第一列</returns>   
        public static long ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            ...
            return long.Parse(retval.ToString());
        }
        public static long ExecuteScalar(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        public static void BatchInsert(DataTable dt, string tablename, SqlTransaction st)
        {

            using (SqlBulkCopy sbc = new SqlBulkCopy(st.Connection))
            {
                try
                {
        ...
        public static int BatchUpdateDataTable(DataTable dt, string tablename, string idcol)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    StringBuilder isb = new StringBuilder(" insert into ");
                    isb.Append(tablename);
                    isb.Append(" ").Append(colsb).Append(" values (");
                    foreach (DataColumn col in dt.Columns)
                    {
                        isb.AppendFormat(" '{0}',", dr[col.ColumnName]);
                    }
                    isb.Replace(',', ')', isb.Length - 1, 1);
                    insertsql.Append(isb).Append('\n');
                }
                if (dr.RowState == DataRowState.Modified)
                {
                    StringBuilder usb = new StringBuilder(" update ");
                    usb.Append(tablename).Append(" set ");
                    bool IsModified = false;
                    foreach (DataColumn col in dt.Columns)
                    {
                        if (dr[col.ColumnName] != dr[col.ColumnName, DataRowVersion.Original])
                        {
                            IsModified = true;
                            usb.AppendFormat(" {0} = '{1}',", col.ColumnName, dr[col]);
                        }
                    }
                    if (IsModified)
                    {
                        usb.Replace(',', ' ', usb.Length, 1);
                        usb.AppendFormat(" where {0} = '{1}' ", idcol, dr[idcol]);
                        updatesql.Append(usb).Append('\n');
                    }
                }
                if (dr.RowState == DataRowState.Deleted)
                {
                    StringBuilder dsb = new StringBuilder(" delete ");
                    dsb.Append(tablename).AppendFormat(" where {0} = '{1}' ", idcol, dr[idcol]);
                    delsql.Append(dsb).Append('\n');
                }
            }
            insertsql.Append(updatesql).Append(delsql);
            try
            {
                int ret = ExecuteNonQuery(GetConnection(), CommandType.Text, insertsql.ToString());
                return ret;
            }
            catch (Exception ex)
            {
        ...
        public static void BatchDelete(DataTable dt, string tablename)
        {
            SqlConnection con = GetConnection();
            SqlCommand cmd = new SqlCommand(" select * from " + tablename + " where 1=2 ", con);
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlDataHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
    ...
    /// <summary>   
    /// SqlDataHelperParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数.   
    /// </summary>   
    public sealed class SqlDataHelperParameterCache
    {
        #region 私有方法,字段,构造函数   
        // 私有构造函数,妨止类被实例化.   
        private SqlDataHelperParameterCache() { }
