...
namespace ConsoleApp1
{
    ...
    {
        private static string my_connstr = "";
        ...
        public static DataTable ExecuteDataTable(SqlConnection conn, String sql, CommandType type, params SqlParameter[] pms)
        {
        ...
        public static DataTable ExecuteDataTable(SqlConnection conn, SqlTransaction tran, CommandType type, string sqlstr, params SqlParameter[] pms)
        {
        ...
        /// <param name="commandParameters">分配给命令的SqlParamter参数数组</param>   
        /// <returns>返回结果集中的第一行第一列</returns>   
        public static int ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
